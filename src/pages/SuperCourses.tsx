  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        ...
        description="Курсы уровня репетитора: физика, математика, информатика, химия, биология, русский и история. Школьная программа и профильный ЕГЭ. Первый урок бесплатно."
        canonical={CANONICAL}
