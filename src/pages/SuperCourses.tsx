...
export default function SuperCourses() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Супер-курсы УЧИСЬПРО — 8 предметов с ИИ-наставником для ЕГЭ"
        description="Курсы уровня репетитора: физика, математика, информатика, химия, биология, русский, история и логика. Школьная программа и профильный ЕГЭ. Первый урок бесплатно."
        canonical={CANONICAL}
        keywords="репетитор егэ, курс логики, логика для школьников, уроки логики, курсы по химии, биология егэ, русский язык егэ, история егэ, физика математика информатика, ии наставник, подготовка к егэ"
        jsonLd={JSON_LD}
      />
