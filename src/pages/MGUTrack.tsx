...
export default function MGUTrack() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="МГУ-трек: стратегия поступления в МГУ с ИИ"
        description="План поступления в МГУ с ИИ-стратегом: 12 топ-факультетов, расчёт целевых баллов ЕГЭ, олимпиады для БВИ и подготовка к ДВИ. Калькулятор шансов."
