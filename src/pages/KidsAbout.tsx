...
export default function KidsAbout() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Малыш — развивающие занятия для детей от 1 до 6 лет"
        description="«Малыш» — чтение, логика, игры, песни и библиотека из 30 озвученных сказок. Развитие ребёнка от 1 года до 6 лет через игру. Безопасно и бесплатно."
        canonical={CANONICAL}
        image={COVER}
        type="article"
