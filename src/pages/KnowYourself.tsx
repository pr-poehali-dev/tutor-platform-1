...
export default function KnowYourself() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Познай себя — тест на профессию и выбор вуза"
        description="Тест на 60+ вопросов определит тип личности по Холланду, сильные стороны и ценности. Подберёт топ-10 профессий и конкретные вузы из базы."
