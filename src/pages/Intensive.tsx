...
export default function Intensive() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <Seo
        title="Автоматизация бизнеса за 7 дней без программирования"
        description="Интенсив по автоматизации микробизнеса с ИИ-наставником: 3 готовые связки за 7 дней — заявки в CRM, авто-напоминания, аналитика. Без программирования, в своём темпе."
        ...
        <section className="mb-14">
          <Reveal>
            <TochkaBusinessBanner
              ...
              text="Расчётный счёт для бизнеса и регистрация ИП или ООО без визита в налоговую — бесплатно у нашего партнёра, Точка Банк. Удобный банк для предпринимателей, которые ценят своё время."
            />
          </Reveal>
        </section>
