...
export default function ExpertContent() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Экспертный контент, который продаёт: статьи и посты"
        description="Курс для экспертов: как писать статьи и посты, которые приводят клиентов. Темы под спрос, заголовки, сторителлинг и воронка через контент. Первый урок бесплатно."
        canonical={CANONICAL}
        type="article"
