...
export default function KidsPoznavashka() {
  ...
  return (
    ...
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Познавашка — окружающий мир и логика для малышей"
        description="Обучающая игра для детей: Ксюша в сказочной стране рассказывает, как устроен окружающий мир. За верные ответы ребёнок получает ЗНАЙКИ."
        canonical={CANONICAL}
