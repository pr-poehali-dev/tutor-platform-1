...
const STEPS = [
  { emoji: "🎯", title: "Выбери профессию", desc: "6 направлений с реальным спросом на рынке" },
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-5 md:px-8 pt-8 pb-16">
        ...
        <section className="text-center mb-10">
          ...
          <p className="text-white/70 text-base max-w-2xl mx-auto">
            Мы изучили вакансии на HH.ru и SuperJob и собрали 6 профессий с реальным спросом, которые можно освоить с нуля и работать удалённо. Для каждой — полноценный курс с практикой и проектом для портфолио.
          </p>
        </section>
