...
export default function ClinicalPsychologist() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Клинический психолог с нуля: КПТ, ACT и DBT онлайн"
        description="Курс доказательной терапии: КПТ, ACT, DBT, работа с тревогой, депрессией и ПТСР, запуск частной практики. Профессия с нуля. Первый урок бесплатно."
        canonical={CANONICAL}
        type="article"
