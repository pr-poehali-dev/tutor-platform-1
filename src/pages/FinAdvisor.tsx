...
export default function FinAdvisor() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Финансовый консультант для бизнеса — честный ИИ-анализ по вашим цифрам"
        description="Введите показатели бизнеса — ИИ-финансист оценит устойчивость, найдёт скрытые возможности, предупредит о рисках и подскажет, как привлечь деньги: инвестиции, гранты, кредиты или оптимизация. Честно и бесплатно."
