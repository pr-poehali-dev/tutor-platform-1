...
export default function MyRussia() {
  ...
  return (
    ...
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Моя Россия — фольклор, сказки и история для детей"
        description="Раздел «Моя Россия» для детей: народный фольклор, малоизвестные русские сказки, песни и история по-простому. Оригинальные тексты с озвучкой, без пафоса."
