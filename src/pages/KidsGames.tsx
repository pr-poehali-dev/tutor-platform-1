...
export default function KidsGames() {
  ...
  return (
    ...
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Игротека — бесплатные логические игры для детей"
        description="Бесплатные логические игры для детей: шахматы, шашки, крестики-нолики, пятнашки, морской бой и другие. Ксюша объясняет правила голосом и играет с ребёнком."
        canonical={CANONICAL}
