...
const FAQ: FaqItem[] = [
  // Оплата
  { cat: "Оплата", q: "Сколько стоит курс?",
    a: "Каждый курс покупается отдельно, цена указана на карточке курса в каталоге /courses. Оплата разовая — доступ к курсу открывается навсегда. Есть и бесплатные курсы, а также бесплатный первый урок." },
  { cat: "Оплата", q: "Как оплатить?",
    a: "Оплата проходит через ЮKassa: банковская карта (Мир, Visa, Mastercard), СБП, ЮMoney. Чек сразу приходит на email. Доступ к курсу открывается в течение минуты." },
  { cat: "Оплата", q: "Можно ли вернуть деньги?",
    a: "Да. В течение 14 дней с момента оплаты можно вернуть полную стоимость, если не нравится. Напиши в обратную связь — /contacts." },
  { cat: "Оплата", q: "Что входит в покупку курса?",
    a: "Оплатив курс один раз, ты получаешь доступ ко всем его урокам и материалам навсегда — без ежемесячных платежей. Все купленные курсы видны в личном кабинете /cabinet." },
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        ...
        description="Ответы на частые вопросы: покупка курсов, оплата, ИИ-репетитор, подготовка к ЕГЭ, безопасность, родительский контроль."
        keywords="центр помощи, часто задаваемые вопросы, поддержка учисьпро, faq"
