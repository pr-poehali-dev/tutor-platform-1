...
export default function ForBusiness() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Своя онлайн-школа на ИИ: запуск за вечер"
        description="Своя онлайн-школа под ключ: ИИ собирает курс за час и учит 24/7, приём оплат, свой бренд и домен. 14 дней бесплатно, дальше — только процент с продаж."
