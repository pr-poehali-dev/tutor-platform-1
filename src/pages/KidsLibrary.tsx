    ...
    <div className="min-h-screen bg-mesh font-golos text-white">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-5 md:px-8 pt-10 md:pt-14 pb-6">
        ...
        <p className="text-white/65 text-base md:text-lg max-w-2xl mb-6">
          Народные сказки, Пушкин, Толстой, Крылов, Ушинский — классика из общественного достояния. Слушайте вместе с малышом: тёплый голос Лисы прочтёт каждый фрагмент.
        </p>
