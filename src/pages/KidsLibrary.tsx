...
export default function KidsLibrary() {
  ...
  const jsonLd = [
    {
      ...
      description:
        "Бесплатная библиотека из 30 произведений общественного достояния для детей от 2 лет и школьников 6+. С озвучкой голосом ИИ. Русские народные сказки, Пушкин, Толстой, Крылов, Ушинский, Жуковский, Аксаков.",
  ...
  return (
    ...
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Библиотека сказок и стихов для детей — слушать онлайн"
