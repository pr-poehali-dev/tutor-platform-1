...
export default function NlpMaster() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="НЛП-практик PRO с нуля: НЛП, КПТ и коучинг онлайн"
        description="Курс НЛП-практика: НЛП, КПТ, эриксоновский гипноз, коучинг ICF и запуск частной практики. Профессия с нуля, сертификат. Первый урок бесплатно."
        canonical={CANONICAL}
        type="article"
