...
export default function BusinessCoach() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Бизнес-тренер и коуч: стратегия роста под ваш бизнес"
        description="Пройдите чек-лист — ИИ-тренер соберёт программу развития и 5-летнюю стратегию роста под ваш бизнес, а наставник поможет не бросить. Программу видно бесплатно."
        canonical={`${SITE_URL}/business-coach`}
        image="https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/files/31dd3c5a-639c-4eae-bd5c-c5c40ffd92cd.jpg"
