...
export default function KidsReading() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Учусь читать с Ксюшей — курс чтения для дошкольников"
        description="Бесплатный курс чтения для детей 4–7 лет: 10 ступенек от всех 33 букв до чтения предложений. Ксюша учит в игре, есть озвучка и памятка для родителей."
        canonical={CANONICAL}
