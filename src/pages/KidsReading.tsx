  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        ...
        description="Лучший бесплатный курс обучения чтению для детей 4–7 лет. Ксюша учит весь алфавит, слоги и чтение слов в весёлой игре. 10 ступенек: от всех 33 букв до самостоятельного чтения предложений. Озвучка, ЗНАЙКИ за ответы и памятка для родителей внутри."
        canonical={CANONICAL}
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-5 md:px-8 pt-8 pb-2 text-center">
        ...
        <p className="text-white/65 text-base md:text-lg max-w-2xl mx-auto">
          Ксюша научит твоего малыша читать — шаг за шагом, от всех букв алфавита до
      ...
      <PoznavashkaGame
        ...
        mapGreeting="Привет! Я Ксюша. Сегодня я научу тебя читать по-настоящему. Мы выучим все буквы алфавита, научимся складывать слоги и слова, а на последней ступеньке ты сам прочитаешь целые предложения! Выбирай ступеньку."
        mapGreetingRich="Привет! Я Ксюша 🌸 Пройдём 10 ступенек: все буквы → слоги → слова → предложения. В конце ты будешь читать сам! Выбирай, с чего начнём!"
      />
