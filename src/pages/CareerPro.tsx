...
export default function CareerPro() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Профориентация PRO: курс под вас с ИИ"
        description="Пройдите чек-лист — ИИ соберёт индивидуальный курс под вашу цель, уровень и нужные навыки. Программа обучения от 10 000 ₽, план курса — бесплатно."
