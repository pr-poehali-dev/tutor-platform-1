...
export default function WritingCraft() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Мастерская сочинений: ЕГЭ, итоговое и журфак"
        description="Курс письма: итоговое сочинение, сочинение ЕГЭ на 25 баллов, журналистские жанры и эссе. 8 модулей, 64 урока. Готовит к поступлению на журфак МГУ, ВШЭ, СПбГУ."
