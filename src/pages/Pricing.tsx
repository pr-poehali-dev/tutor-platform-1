...
import PricingForWhom from "@/components/pricing/PricingForWhom";
import PricingSubjects from "@/components/pricing/PricingSubjects";
...
const FAQ = [
  ...
  {
    q: "Подходит ли для подготовки к ЕГЭ в 11 классе?",
    a: "Да. В подписку входят задачники по структуре ЕГЭ, разбор заданий с объяснением каждого шага и диагностика пробелов. Все предметы сразу — не нужно нанимать отдельного репетитора по математике, физике и информатике.",
  },
  {
    q: "Что с подготовкой к ОГЭ в 9 классе?",
    a: "Задания ОГЭ разбираются по структуре экзамена. Сначала находим темы, которые провалены, затем добираем именно их. Количество занятий не ограничено, можно заниматься каждый день.",
  },
  {
    q: "Сколько стоит онлайн-репетитор для школьника?",
    a: "1 490 ₽ в месяц за все предметы без ограничения по количеству занятий. Для сравнения: одно занятие с частным репетитором стоит в среднем 1 200 ₽, а месяц занятий дважды в неделю — около 9 600 ₽ за один предмет.",
  },
  {
    q: "Нужно ли заниматься по расписанию?",
    a: "Нет. Урок начинается тогда, когда вам удобно — вечером, в выходной, на каникулах или ночью перед пробником. Записываться и согласовывать время не нужно.",
  },
];
...
export default function Pricing() {
  return (
    <div className="min-h-screen bg-mesh">
      <Seo
        title="Онлайн-репетитор для школьников по подписке — 1490 ₽/мес"
        description="Онлайн-репетитор для школьников и подготовка к ЕГЭ и ОГЭ по подписке: все предметы, безлимит занятий и проверка домашки за 1490 ₽ в месяц. Дешевле частного репетитора, занятия круглосуточно."
        canonical={`${SITE_URL}/pricing`}
        keywords="онлайн репетитор для школьников, репетитор 11 класс онлайн, репетитор 9 класс онлайн, репетитор по подписке, каталог репетитор по подписке, онлайн репетитор подготовка, подготовка к егэ репетитор онлайн, репетитор онлайн старшекласснику, сколько стоит онлайн репетитор"
      ...
      <section className="max-w-4xl mx-auto px-4 pt-8 pb-4 text-center">
        ...
        <h1 className="font-montserrat font-black text-3xl md:text-5xl text-white leading-tight mb-5">
          Онлайн-репетитор для школьников
          <br />
          <span className="gradient-text-purple">по подписке — 1 490 ₽ в месяц</span>
        </h1>
        <p className="text-white/70 text-lg leading-relaxed max-w-2xl mx-auto mb-8">
          Одна оплата вместо счёта за каждое занятие. Все предметы с 1 по 11 класс,
          подготовка к ЕГЭ и ОГЭ, занятия круглосуточно и проверка домашних заданий —
