  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        ...
        description="УЧИСЬПРО — современная образовательная платформа с персональным ИИ-репетитором, который доступен круглосуточно. Голосовое и текстовое общение, адаптивные программы по математике, физике, русскому, английскому и другим школьным предметам. Диагностика пробелов, разбор заданий ЕГЭ и ОГЭ, прогресс с уровнями и бейджами. Есть курсы для взрослых: нейросети, запуск бизнеса и удалённые профессии. Официальный партнёр Точка Банк. Первый урок бесплатно на учисьпро.рф."
        canonical="https://xn--h1agdcde2c.xn--p1ai/"
        keywords="учисьпро, учисьпро.рф, репетитор онлайн, ии репетитор, подготовка к егэ, подготовка к огэ, онлайн школа, курсы для школьников, математика онлайн, физика онлайн, английский онлайн, голосовой репетитор, курсы по нейросетям, курсы для взрослых, удалённые профессии, партнёр точка банк"
        jsonLd={HOME_JSON_LD}
      />
