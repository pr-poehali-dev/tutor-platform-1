...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { label: "База по городам-миллионникам", path: "/admin/city-plan", icon: "MapPin", description: "16 городов от 1 млн: план обхода волнами, ссылки на поиск по нишам и прогресс сбора контактов" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Студия ИИ-ботов", path: "/admin/bot-studio", icon: "ScanFace", description: "Говорящие персоны с лицом и голосом" },
