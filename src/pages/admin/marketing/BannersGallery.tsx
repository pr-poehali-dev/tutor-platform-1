...
const BANNERS: Banner[] = [
  {
    id: "referral",
    title: "Приведи друга",
    desc: "+7 дней подписки тебе и другу",
    format: "Пост · квадрат",
    url: "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/files/efcf3786-586b-41b9-8c9f-dd4f9c20dfcd.jpg",
    post:
      "🎁 Приведи друга — получите по +7 дней подписки каждый!\n\n" +
      "Учиться вместе веселее и выгоднее. Всё просто:\n" +
      "1️⃣ Берёшь свой промокод в личном кабинете\n" +
      "2️⃣ Делишься с другом\n" +
      ...
      `Забрать промокод → ${SITE}/referral`,
  },
  {
    id: "universal",
    title: "Универсальный",
