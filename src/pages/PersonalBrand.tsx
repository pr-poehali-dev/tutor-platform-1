...
export default function PersonalBrand() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Личный бренд эксперта: SMM-стратегия и репутация"
        description="Личный бренд для руководителей и экспертов без команды и бюджета: аудит присутствия, контент-стратегия, сторителлинг и план на 6 месяцев. Первый урок бесплатно."
        canonical={CANONICAL}
        type="article"
