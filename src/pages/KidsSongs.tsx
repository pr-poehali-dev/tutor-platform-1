...
export default function KidsSongs() {
  ...
  return (
    ...
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Детские песенки, потешки и колыбельные с текстами"
        description="Народные потешки «Ладушки» и «Сорока-белобока», пальчиковые игры, авторские песенки, считалочки и колыбельные. Каждая с подсветкой строк и советом родителю."
