...
export default function GrantAssistant() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="ИИ-помощник по грантам: заявка на грант за минуты"
        ...
        keywords="гранты для бизнеса, заявка на грант, помощь в оформлении гранта, субсидии малому бизнесу, гранты 2026"
