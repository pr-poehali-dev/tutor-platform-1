...
export default function Psychology() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Психологическая помощь онлайн бесплатно — ИИ-психолог"
        description="Бесплатный ИИ-психолог и наставник без регистрации. Помощь при тревоге, выгорании, стрессе и одиночестве — для родителей, подростков и взрослых. Конфиденциально."
        canonical={CANONICAL}
