  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        ...
        description="Персональный PDF-разбор вашей бизнес-идеи: юнит-экономика, точка безубыточности, стресс-тест на падение продаж, проверка кредита, риски и план на первые 90 дней. Считается по вашим цифрам за 15 минут."
