...
export default function Orchestrator() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Оркестратор: онбординг и контроль удалённых команд"
        description="Укажите роль и проект — ИИ соберёт трек адаптации исполнителя: матрица навыков, входной контроль, онбординг по дням и задачи с критериями. Генерация бесплатна."
