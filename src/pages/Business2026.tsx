...
export default function Business2026() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Бизнес 2026: где открываться в 16 городах-миллионниках России | УЧИСЬПРО"
        description="Аналитические записки по всем городам-миллионникам России: что происходит с экономикой, какие ниши приоритетны в 2026 году и чего избегать. Цифры, выводы и способ проверить идею за неделю."
