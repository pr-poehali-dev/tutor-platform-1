...
export default function BizLab() {
  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        title="Проверить бизнес-идею на прочность — тренажёр"
        description="8 этапов моделирования бизнеса: юнит-экономика, точка безубыточности и стресс-тест на падение продаж. Честный вердикт по вашим цифрам. Бесплатно, без регистрации."
