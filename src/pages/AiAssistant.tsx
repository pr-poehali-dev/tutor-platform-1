...
export default function AiAssistant() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <Seo
        title="ИИ-ассистент для работы: нейросети за 5 дней"
        description="Практический курс по ChatGPT и нейросетям в работе: тексты, письма, таблицы и отчёты в разы быстрее. Тренажёр промптов и 100+ готовых шаблонов. Без опыта."
