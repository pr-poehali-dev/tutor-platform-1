...
/**
 * Неброский маркер доверия: партнёрство с банком «Точка».
...
export default function TochkaPartnerBadge({ className = "" }: Props) {
  return (
    <a
      ...
      aria-label="Партнёр проекта — банк Точка"
      title="Партнёр проекта — банк Точка"
    ...
    >
      ...
      <span className="flex items-center gap-1.5 text-xs md:text-[13px] font-medium text-white/85">
        ...
        Партнёр проекта — банк <span className="font-bold text-white">Точка</span>
      </span>
    </a>
  );
}
