...
import { Faculty, QuickCompat, SUBJECT_LABELS } from "./mguTrackTypes";

interface Props {
  faculties: Faculty[];
  selected: Faculty | null;
  setSelected: (f: Faculty) => void;
  setQuickCompat: (v: QuickCompat | null) => void;
  setPlan: (v: null) => void;
  scores: Record<string, number>;
  setScores: (v: Record<string, number>) => void;
  grade: string;
...
export default function MGUTrackCalculator({
  faculties,
  selected,
  setSelected,
  setQuickCompat,
