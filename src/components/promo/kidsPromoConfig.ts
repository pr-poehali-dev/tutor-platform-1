// Конфигурация акции «К учебному году»: первые 3 месяца за 1 ₽, далее 399 ₽/мес.
//
// Раньше акция гасла 1 сентября — то есть ровно в тот день, когда родители
// массово ищут, где подтянуть ребёнка. Продлеваем до конца сентября:
// сентябрь — главный месяц спроса, выключать скидку в его начале нелогично.

export const KIDS_PROMO_END_ISO = "2026-09-30T23:59:59+03:00";
