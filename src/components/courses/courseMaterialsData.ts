...
const CUSTOM_MATERIALS: Record<number, CourseMaterial[]> = {
  ...
  // id 65 — Нейросети с нуля
  65: [
    { kind: "cheatsheet", title: "Шпаргалка «Какая нейросеть для чего»", description: "ChatGPT, Claude, Gemini, Midjourney, Kandinsky — что выбрать под текст, картинки, видео и озвучку. Доступ из России и бесплатные тарифы." },
    { kind: "template", title: "Формула сильного промпта + 20 шаблонов", description: "Роль-задача-контекст-формат и готовые промпты под частые дела: письма, посты, идеи, анализ. Копируй и подставляй своё." },
    { kind: "workbook", title: "Рабочая тетрадь практика", description: "Задания по каждому модулю: первый диалог с ИИ, генерация картинок, сборка ролика, автоматизация рутины — с результатом в конце." },
    { kind: "glossary", title: "Словарь терминов ИИ простыми словами", description: "Нейросеть, токен, промпт, галлюцинация, контекст — без сложных слов, чтобы уверенно понимать материал." },
    { kind: "checklist", title: "Чек-лист безопасной работы с ИИ", description: "Что нельзя отправлять в нейросети, как проверять факты и соблюдать авторские права." },
    { kind: "scheme", title: "Карта возможностей нейросетей", description: "Наглядная схема: где ИИ экономит время в учёбе, работе и быту, и с чего начать новичку." },
  ],
