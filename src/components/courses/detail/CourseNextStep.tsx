...
const NEXT: Record<number, { id: number; pitch: string }> = {
  ...
  // «Кадровые документы: аудит» → полный учёт без штрафов
  90: {
    id: 91,
    pitch:
      "Пробелы вы нашли. Дальше — как их закрыть: договоры без опасных формулировок, увольнения, которые не оспорят в суде, персональные данные, воинский учёт и подготовка к проверке.",
  },
