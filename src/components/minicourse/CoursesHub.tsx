  ...
  return (
    <div className="min-h-screen bg-mesh font-golos text-white">
      <Seo
        ...
        description={`${MINI_COURSES.length} бесплатных мини-курсов для взрослых и школьников: нейросети, зарплата, переговоры, права потребителя, сон, здоровье спины, готовка, ремонт, фото, а также математика, физика, английский и астрономия. Без регистрации и оплаты.`}
