...
export const GAMES_FAQ = [
  {
    q: "С какого возраста учить ребёнка шахматам?",
    a: "Знакомить с шахматами можно с 4–5 лет, когда ребёнок понимает правила и удерживает внимание. В Игротеке Ксюша объясняет ходы фигур простыми словами и играет на уровне малыша, постепенно усложняя партии.",
  },
  {
    q: "В какие игры полезно играть дошкольнику?",
    a: "Для развития логики и внимания подходят крестики-нолики, пятнашки, шашки, «найди пару» и «пять в ряд». Игры на память (Повторяшка, мемори) тренируют запоминание, а «угадай число» — счёт и сравнение чисел.",
  },
  {
    q: "Игры бесплатные?",
    a: "Да, все игры в Игротеке бесплатные, без рекламы и без скрытых платежей. За победы ребёнок получает внутренние баллы ЗНАЙКИ.",
  },
  {
    q: "Ребёнок играет один или с компьютером?",
    a: "В играх с соперником (шахматы, шашки, крестики-нолики, пять в ряд, реверси) Ксюша играет вместе с ребёнком и подстраивает сложность: если малыш выигрывает несколько партий подряд, она начинает играть сильнее.",
  },
  {
    q: "Чем игры полезны для развития?",
    a: "Настольные и логические игры развивают внимание, память, стратегическое мышление и усидчивость. А голосовое сопровождение Ксюши помогает запоминать правила и тренирует восприятие речи.",
  },
];
