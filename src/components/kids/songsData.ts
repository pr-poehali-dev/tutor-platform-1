...
export const SONGS: Song[] = [
  ...
  },
  {
    ...
    lines: [
      { text: "По тропинке я иду,", seconds: 7, at: 0.5, action: "Шагаем на месте" },
      { text: "Прыг-скок, прыг-скок!", seconds: 7, at: 9.9, action: "Прыгаем на двух ножках" },
      { text: "Под листочком я найду", seconds: 7, at: 19.4, action: "Наклоняемся, «заглядываем» под листок" },
      { text: "Маленький грибок.", seconds: 7, at: 28.8, action: "Показываем ладошками «шляпку»" },
      { text: "Прыг-скок, прыг-скок,", seconds: 7, at: 38.2, action: "Прыгаем" },
      { text: "Вырос в лесу грибок!", seconds: 7, at: 47.7, action: "Тянемся ручками вверх" },
      { text: "Прыг-скок, прыг-скок,", seconds: 7, at: 57.1, action: "Прыгаем" },
      { text: "Рыженький бочок.", seconds: 7, at: 66.6, action: "Гладим себя по бочку" },
      { text: "Солнышко в лесу встаёт,", seconds: 7, at: 76.0, action: "Рисуем в воздухе круг" },
      { text: "Птички нам поют.", seconds: 7, at: 85.4, action: "Машем ручками как крылышками" },
      { text: "Кто по тропочке идёт —", seconds: 7, at: 94.9, action: "Шагаем на месте" },
      { text: "Грибочки соберут!", seconds: 7, at: 105.8, action: "«Собираем» грибочки в корзинку" },
    ],
    parentTip: "Включи песенку и попрыгайте вместе с малышом на месте в такт музыке — «как грибочек растёт». Отлично подходит для весёлой зарядки и разучивания движений по словам.",
    original: true,
    audioUrl:
  ...
  },
  {
    ...
    lines: [
      { text: "Тихо-тихо в лесу,", seconds: 13, at: 14.0, action: "Прикладываем пальчик к губам: «тс-с»" },
      { text: "Спит трава на весу.", seconds: 13, at: 32.3 },
      { text: "Сонный ёжик идёт,", seconds: 13, at: 47.7, action: "Медленно «шагаем» пальчиками" },
      { text: "Свой фонарик несёт.", seconds: 13, at: 63.0 },
      { text: "Баю-бай, засыпай,", seconds: 13, at: 78.3, action: "Качаем «колыбельку» руками" },
      { text: "Глазки, ёжик, закрывай.", seconds: 13, at: 96.7, action: "Прикрываем глазки ладошками" },
      { text: "Звёзды в небе горят,", seconds: 13, at: 112.0, action: "Тихонько шевелим пальчиками-звёздочками" },
      { text: "Ёжик спит, и ты, малыш, спи.", seconds: 13, at: 127.3 },
      { text: "Ветер песенку поёт,", seconds: 13, at: 142.7 },
      { text: "Ночь по лесу идёт.", seconds: 13, at: 158.0 },
      { text: "Спит и мишка, и лиса,", seconds: 13, at: 175.1 },
      { text: "Закрывай и ты глаза.", seconds: 15, at: 190.4, action: "Обнимаем малыша" },
    ],
