...
export const SONGS: Song[] = [
  ...
  },
  {
    ...
    lines: [
      { text: "По тропинке я иду,", seconds: 7, at: 8, action: "Шагаем на месте" },
      { text: "Прыг-скок, прыг-скок!", seconds: 7, at: 15, action: "Прыгаем на двух ножках" },
      { text: "Под листочком я найду", seconds: 7, at: 22, action: "Наклоняемся, «заглядываем» под листок" },
      { text: "Маленький грибок.", seconds: 7, at: 29, action: "Показываем ладошками «шляпку»" },
      { text: "Прыг-скок, прыг-скок,", seconds: 7, at: 40, action: "Прыгаем" },
      { text: "Вырос в лесу грибок!", seconds: 7, at: 47, action: "Тянемся ручками вверх" },
      { text: "Прыг-скок, прыг-скок,", seconds: 7, at: 54, action: "Прыгаем" },
      { text: "Рыженький бочок.", seconds: 7, at: 61, action: "Гладим себя по бочку" },
      { text: "Солнышко в лесу встаёт,", seconds: 7, at: 72, action: "Рисуем в воздухе круг" },
      { text: "Птички нам поют.", seconds: 7, at: 79, action: "Машем ручками как крылышками" },
      { text: "Кто по тропочке идёт —", seconds: 7, at: 86, action: "Шагаем на месте" },
      { text: "Грибочки соберут!", seconds: 7, at: 93, action: "«Собираем» грибочки в корзинку" },
    ],
  ...
  },
  {
    ...
    lines: [
      { text: "Тихо-тихо в лесу,", seconds: 13, at: 12, action: "Прикладываем пальчик к губам: «тс-с»" },
      { text: "Спит трава на весу.", seconds: 13, at: 25 },
      { text: "Сонный ёжик идёт,", seconds: 13, at: 38, action: "Медленно «шагаем» пальчиками" },
      { text: "Свой фонарик несёт.", seconds: 13, at: 51 },
      { text: "Баю-бай, засыпай,", seconds: 13, at: 66, action: "Качаем «колыбельку» руками" },
      { text: "Глазки, ёжик, закрывай.", seconds: 13, at: 79, action: "Прикрываем глазки ладошками" },
      { text: "Звёзды в небе горят,", seconds: 13, at: 100, action: "Тихонько шевелим пальчиками-звёздочками" },
      { text: "Ёжик спит, и ты, малыш, спи.", seconds: 13, at: 113 },
      { text: "Ветер песенку поёт,", seconds: 13, at: 135 },
      { text: "Ночь по лесу идёт.", seconds: 13, at: 148 },
      { text: "Спит и мишка, и лиса,", seconds: 13, at: 165 },
      { text: "Закрывай и ты глаза.", seconds: 15, at: 182, action: "Обнимаем малыша" },
    ],
