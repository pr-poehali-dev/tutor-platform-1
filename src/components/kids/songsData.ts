...
export const SONGS: Song[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    lines: [
      { text: "Баю-баюшки-баю,", seconds: 6, at: 10, action: "Качаем «колыбельку» руками" },
      { text: "Не ложися на краю.", seconds: 6, at: 16 },
      { text: "Тихо-смирно засыпай,", seconds: 6, at: 22, action: "Прикладываем пальчик к губам: «тс-с»" },
      { text: "Глазки, детка, закрывай.", seconds: 6, at: 28, action: "Прикрываем глазки ладошками" },
      { text: "Придёт серенький волчок,", seconds: 6, at: 34, action: "Показываем «ушки» волчка" },
      { text: "Он ухватит за бочок,", seconds: 4, at: 38 },
      { text: "И утащит во лесок,", seconds: 4, at: 42 },
      { text: "Под ракитовый кусток.", seconds: 6, at: 46, action: "Прячем ладошки" },
      { text: "К нам, волчок, не ходи,", seconds: 6, at: 52, action: "Грозим пальчиком" },
      { text: "Нашу детку не буди.", seconds: 6, at: 58 },
      { text: "Баю-баюшки-баю,", seconds: 6, at: 64, action: "Качаем «колыбельку» руками" },
      { text: "Я над сном твоим стою.", seconds: 6, at: 70 },
      { text: "Спи, родная, спи скорей,", seconds: 6, at: 76, action: "Гладим малыша по головке" },
      { text: "Месяц смотрит с вышины,", seconds: 6, at: 82, action: "Показываем месяц в небе" },
      { text: "Охраняет детские сны.", seconds: 6, at: 88 },
      { text: "Пусть летает снежный пух,", seconds: 6, at: 94, action: "Плавно перебираем пальчиками" },
      { text: "А над домом — тишина,", seconds: 6, at: 100, action: "Прикладываем пальчик к губам" },
      { text: "Светит ласково луна.", seconds: 6, at: 106 },
      { text: "Баю-баюшки-баю,", seconds: 6, at: 112, action: "Качаем «колыбельку» руками" },
      { text: "Я над сном твоим стою.", seconds: 6, at: 118 },
      { text: "Тихо-тихо, не спеша,", seconds: 6, at: 124, action: "Медленно опускаем ручки" },
      { text: "Спит доверчивая душа.", seconds: 6, at: 130 },
      { text: "Под ракитовым кустом,", seconds: 6, at: 136, action: "Прячем ладошки" },
      { text: "К нам, волчок, не ходи,", seconds: 6, at: 142, action: "Грозим пальчиком" },
      { text: "Нашу детку не буди.", seconds: 6, at: 148 },
      { text: "Баю-баюшки-баю,", seconds: 6, at: 154, action: "Обнимаем малыша" },
      { text: "Я над сном твоим стою.", seconds: 6, at: 158 },
    ],
    ...
    audioUrl:
      "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/bucket/8e9ef9f1-7d35-465b-9bbb-425d39dd328c.mp3",
  },
  {
    id: "spat-pora",
