...
/** Аватарки категорий в русском народном стиле (гжель / хохлома).
 *  Гжель (сине-белая) — потешки и колыбельные; хохлома (золото-красная) —
 *  песенки, стихи и пальчиковые игры. Показываются на карточке и в плеере. */
export const CATEGORY_AVATARS: Record<SongCategory, string> = {
  potyashka: "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/files/17215d79-ad62-4d18-88ae-bf8ac2b1df80.jpg",
  finger: "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/files/bc36d050-dfa5-484b-a8f1-bc146cab705c.jpg",
  song: "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/files/f93c82ab-8ceb-40fb-9c38-5e3012774683.jpg",
  poem: "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/files/d081838b-5800-4f31-a499-97d4a56e112f.jpg",
  lullaby: "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/files/0e617a45-2979-4b48-99ab-05ccc48ed8c2.jpg",
};

/** Аватарка песни в народном стиле: явная (song.avatarUrl) или по категории. */
export function getSongAvatar(song: Song): string {
  return song.avatarUrl || CATEGORY_AVATARS[song.category];
}
...
export interface Song {
  ...
  audioUrl?: string;
  /** Персональная аватарка песни (народный стиль). Если не задана — берётся
   *  общая аватарка категории из CATEGORY_AVATARS. */
  avatarUrl?: string;
}
...
export const SONGS: Song[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    lines: [
      { text: "Баю-баюшки-баю,", seconds: 6, at: 18, action: "Качаем «колыбельку» руками" },
      { text: "Не ложися на краю.", seconds: 6, at: 24 },
      { text: "Придёт серенький волчок,", seconds: 6, at: 30, action: "Показываем «ушки» волчка" },
      { text: "Он ухватит за бочок", seconds: 6, at: 36 },
      { text: "И утащит во лесок,", seconds: 4, at: 40 },
      { text: "Под ракитовый кусток.", seconds: 4, at: 44, action: "Прячем ладошки" },
      { text: "Баю-баюшки-баю,", seconds: 6, at: 48, action: "Качаем «колыбельку» руками" },
      { text: "Не ложися на краю.", seconds: 6, at: 54 },
      { text: "Придёт серенький волчок,", seconds: 6, at: 60 },
      { text: "Он ухватит за бочок.", seconds: 4, at: 64 },
      { text: "К нам, волчок, не ходи,", seconds: 6, at: 68, action: "Грозим пальчиком" },
      { text: "Нашу детку не буди.", seconds: 6, at: 72 },
      { text: "Сон по комнатам плывёт,", seconds: 6, at: 78, action: "Плавно водим ладошкой" },
      { text: "Сладкий сон тебя найдёт.", seconds: 6, at: 84, action: "Прикрываем глазки ладошками" },
      { text: "Баю-баюшки-баю.", seconds: 6, at: 90, action: "Обнимаем малыша" },
    ],
    ...
    avatarUrl:
      "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/bucket/ec62dabb-fc5d-4997-9cd7-0585d60cc6f3.jpg",
    audioUrl:
      "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/bucket/9b41fa55-5257-4d56-bba4-578b1df848fc.mp3",
  },
  {
    id: "spat-pora",
    ...
    lines: [
      { text: "Тише, тише, ночь идёт,", seconds: 5, at: 10, action: "Прикладываем пальчик к губам: «тс-с»" },
      { text: "Месяц по небу плывёт.", seconds: 5, at: 14, action: "Рисуем в воздухе месяц" },
      { text: "Все игрушки спать легли —", seconds: 5, at: 18, action: "Складываем ладошки под щёчку" },
      { text: "Зайки, мишки и слоны.", seconds: 5, at: 22 },
      { text: "Тише, тише, тише, тише, ночь укрыла всё вокруг,", seconds: 6, at: 26, action: "Плавно качаем руками" },
      { text: "Тише, тише, сладко дышишь, и уходит шум и звук.", seconds: 6, at: 32 },
      { text: "Тише, трава спит, цветочек и звезда,", seconds: 6, at: 40, action: "Медленно опускаем ручки" },
      { text: "Засыпай скорей, малыш, в уютной кроватке спи.", seconds: 6, at: 46, action: "Обнимаем малыша" },
      { text: "Тише, тише, тише, тише, ночь укрыла всё вокруг,", seconds: 6, at: 52, action: "Плавно качаем руками" },
      { text: "Тише, тише, сладко дышишь, и уходит шум и звук.", seconds: 6, at: 58 },
      { text: "Завтра солнышко взойдёт, новый день к нам в гости ждёт,", seconds: 6, at: 65 },
      { text: "А пока глаза закрой — сон идёт к тебе домой.", seconds: 6, at: 72, action: "Прикрываем глазки ладошками" },
      { text: "Тише, тише, тише, тише, ночь укрыла всё вокруг,", seconds: 6, at: 80, action: "Плавно качаем руками" },
      { text: "Тише, тише, сладко дышишь, и уходит шум и звук.", seconds: 8, at: 86, action: "Обнимаем малыша" },
    ],
    ...
    avatarUrl:
      "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/bucket/ec62dabb-fc5d-4997-9cd7-0585d60cc6f3.jpg",
    audioUrl:
      "https://cdn.poehali.dev/projects/b18d4f87-2b38-4fb5-a766-cc6cbae44e5a/bucket/73614444-c07d-4913-9679-42de5d0459b9.mp3",
  },
  {
    id: "pryg-skok-gribok",
    ...
    lines: [
      { text: "Утром лужа как блюдце — не кораблик,", seconds: 5, at: 3, action: "Шагаем на месте" },
      { text: "Шлёпнул носом я, шагнул — и вдруг смеётся", seconds: 5, at: 12 },
      { text: "Наш подъезд своим колёсиком, на перилах —", seconds: 5, at: 16 },
      { text: "Кот усатый смотрит, будто всё он знает,", seconds: 5, at: 20, action: "«Крадёмся» как котик" },
      { text: "А в кармане лист помятый, он как карта убегает.", seconds: 5, at: 24 },
      { text: "Раз, два, три — не спеши, посмотри, что внутри!", seconds: 4, at: 30, action: "Считаем на пальчиках" },
      { text: "Прыг-скок, грибок, прыг-скок — под ногой звонок,", seconds: 5, at: 34, action: "Прыгаем на двух ножках" },
      { text: "Прыг-скок, грибок — и уже урок!", seconds: 5, at: 38, action: "Тянемся ручками вверх" },
      { text: "На заборе тётя Роза вешает бельё как флаги,", seconds: 5, at: 50, action: "Машем ручками" },
      { text: "Рядом дремлет старая коза и жуёт смешные шпаги.", seconds: 5, at: 55 },
      { text: "Я нашёл в траве горошек, он укатился прямо в нос", seconds: 5, at: 60, action: "«Ловим» горошек" },
      { text: "И сказал мне: «Эй, хороший, улыбнись!»", seconds: 5, at: 66, action: "Улыбаемся" },
      { text: "Раз, два, три — не зевай, поверни наш трамвай!", seconds: 4, at: 70, action: "«Крутим руль»" },
      { text: "Прыг-скок, грибок, прыг-скок — под ногой звонок,", seconds: 5, at: 74, action: "Прыгаем" },
      { text: "Прыг-скок, грибок — и уже урок!", seconds: 5, at: 78, action: "Прыгаем" },
      { text: "Если хмурая беда — можно прыгнуть в облака,", seconds: 5, at: 85, action: "Тянемся к «облакам»" },
      { text: "Где-то спряталась звезда, у меня в рукаве пока.", seconds: 5, at: 92 },
      { text: "Прыг-скок, грибок — это так легко!", seconds: 6, at: 105, action: "Прыгаем и кружимся" },
    ],
    parentTip: "Весёлая песенка-фантазия про утро и грибок. Попрыгайте вместе с малышом на припеве «прыг-скок» и повторяйте движения по словам. Отличная музыкальная зарядка.",
    original: true,
    audioUrl:
  ...
  },
  {
    ...
    title: "Сонный ёжик",
    author: "УЧИСЬПРО",
    authorNote: "Оригинальная колыбельная УЧИСЬПРО",
    category: "lullaby",
    ages: ["1-3", "3-5"],
    emoji: "🦔",
    color: "from-indigo-400 to-violet-600",
    tags: ["природа", "сон", "животные"],
    teaches: ["успокаиваться перед сном", "слушать спокойную музыку", "ритуал засыпания"],
    lines: [
      { text: "Ночь укрыла дом серым одеялом.", seconds: 10, at: 12, action: "Прикладываем пальчик к губам: «тс-с»" },
      { text: "Спи, мой малышок, завтра будет утро.", seconds: 10, at: 22, action: "Качаем «колыбельку» руками" },
      { text: "За окном луна смотрит осторожно,", seconds: 8, at: 30 },
      { text: "Сон уже у нас на ладошке.", seconds: 8, at: 36, action: "Раскрываем ладошку" },
      { text: "Тише, тише, тише — сердце, отдыхай,", seconds: 8, at: 42, action: "Гладим себя по груди" },
      { text: "Глазки закрываются, сон к тебе давай.", seconds: 10, at: 50, action: "Прикрываем глазки ладошками" },
      { text: "Баю-бай, баю-бай, ночь пришла в наш дом,", seconds: 10, at: 66 },
      { text: "Сон идёт пешком.", seconds: 8, at: 78, action: "Медленно «шагаем» пальчиками" },
      { text: "Ёжик у крыльца спрятал в лапке звёзды,", seconds: 8, at: 88, action: "Прячем «звёздочки» в кулачок" },
      { text: "Кошка на окне, а я тихо кружу.", seconds: 8, at: 96 },
      { text: "Мишка на подушке дремлет у двери,", seconds: 8, at: 102, action: "Кладём ладошки под щёчку" },
      { text: "И в твоём окошке засверкали сны.", seconds: 8, at: 110 },
      { text: "Тише, тише, тише — сердце, отдыхай,", seconds: 8, at: 118, action: "Гладим по груди" },
      { text: "Глазки закрываются, сон к тебе давай.", seconds: 8, at: 124, action: "Прикрываем глазки" },
      { text: "Баю-бай, баю-бай, спи, мой сладкий зай.", seconds: 10, at: 132, action: "Обнимаем малыша" },
      { text: "Пусть устанут ножки, пусть устанут ручки,", seconds: 8, at: 152, action: "Тихонько гладим ножки и ручки" },
      { text: "Завтра будет солнце и весёлый лучик.", seconds: 8, at: 160 },
      { text: "А сейчас тихонько я с тобой побуду,", seconds: 8, at: 166 },
      { text: "Пока ты уснёшь. Баю-бай, спи, мой сладкий.", seconds: 12, at: 172, action: "Обнимаем малыша" },
    ],
    parentTip: "Медленная колыбельная для ритуала сна. Пой шёпотом или тихонько подпевай, покачивая малыша. Хорошо ставить последней — как сигнал «пора спать».",
    original: true,
    melodyStyle: "lullaby",
    audioUrl:
