        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <nav aria-label="Полезные ссылки">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/feed/partnyorskie-programmy-s-bankom-tochka" className="text-violet-200 hover:text-violet-100 transition-colors font-bold">🤝 Партнёрство с банком Точка</Link></li>
