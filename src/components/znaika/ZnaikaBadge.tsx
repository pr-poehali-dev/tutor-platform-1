...
export default function ZnaikaBadge() {
  ...
  return (
    <Link
      ...
      title="Мои ЗНАЙКИ"
      className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gradient-to-r from-amber-500/15 to-orange-500/10 border border-amber-400/25 hover:from-amber-500/25 hover:to-orange-500/20 transition-all"
    >
