...
STATIC_INDEX = [
    ...
    {
        'kind': 'page', 'emoji': '💳', 'title': 'Тарифы и подписка',
        'subtitle': 'Цены и условия',
        'url': '/pricing', 'category': 'Подписка',
        'keywords': 'подписка тариф цена оплата купить премиум доступ месяц год',
    },
    {
