...
COURSE_ID_PRICE_KOPECKS = {
    ...
    77: 1490000,   # НЛП-практик PRO
    78: 1790000,   # Клинический психолог-консультант (КПТ/ACT/DBT)
    79: 690000,    # Личный бренд эксперта: SMM-стратегия и управление репутацией
    80: 590000,    # Экспертный контент, который продаёт: статьи и посты для клиентов
    84: 1190000,   # Бухгалтер с нуля до трудоустройства
    85: 990000,    # AutoCAD с нуля: 2D + 3D
    86: 1490000,   # Биржевой трейдинг + робот на Python
    87: 1690000,   # Кибербезопасность с нуля до трудоустройства
    88: 1790000,   # DevOps-инженер с нуля до Middle
    # Супер-курсы (предметы репетитора) — разовая покупка предмета, 1990 ₽.
    # Доступ до конца учебного года. СИНХРОНИЗИРОВАНО с superCourses.ts.
    9001: 199000,  # Предмет: Физика
    9002: 199000,  # Предмет: Математика
    9003: 199000,  # Предмет: Информатика
    9004: 199000,  # Предмет: Химия
    9005: 199000,  # Предмет: Биология
    9006: 199000,  # Предмет: Русский язык
    9007: 199000,  # Предмет: История
    # Пакеты предметов. СИНХРОНИЗИРОВАНО с coursePackages.ts.
    9100: 899000,  # Комплекс: все 7 предметов, 8990 ₽
    9101: 449000,  # Пакет «Технический профиль», 4490 ₽
    9102: 449000,  # Пакет «Медико-биологический профиль», 4490 ₽
    9103: 449000,  # Пакет «Гуманитарный профиль», 4490 ₽
    # Профориентация PRO — доступ к живому наставнику-дневнику (коуч-психолог), 10 000 ₽.
    9200: 1000000,  # Наставник PRO: дневник-коуч и сопровождение по 5-летнему плану
    # Бизнес-тренер и коуч — доступ к живому бизнес-наставнику-дневнику, 10 000 ₽.
    9201: 1000000,  # Бизнес-коуч PRO: дневник-наставник и сопровождение по стратегии роста
    # Финансовый консультант — доступ к живому ИИ-финансисту-дневнику, 10 000 ₽.
    9202: 1000000,  # Финансовый консультант PRO: дневник-финансист и сопровождение по финансам бизнеса
